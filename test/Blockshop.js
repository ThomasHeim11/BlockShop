...
describe("Blockshop", () => {
  ...
  describe("Listing", () => {
    ...
    beforeEach(async () => {
      // List a item
      transaction = await blockshop.connect(deployer).list(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
  ...
  describe("Withdrawing", () => {
    ...
    beforeEach(async () => {
      // List a item
      let transaction = await blockshop.connect(deployer).list(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
      await transaction.wait()
